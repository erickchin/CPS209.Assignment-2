...
/**
 * Train Engine is a vehicle object that can pull a chain of railcars and is
 * drawn onto the JPanel
 *
 * @author Erick Chin
 * @date April 04, 2015
 */
public class TrainEngine extends Vehicle {
    ...
    /**
     * Constants used to give the dimensions for the train engine
     */
    ...
    /**
     * Constructor to set up the Train Engine with the parameters of coordinates
     *
    ...
    /**
     * Draws the train engine with Graphics2D
     *
    ...
    public void draw(Color color, Graphics2D g2) {
        ...
        body = new Rectangle2D.Double(x1 + U3,
                y1,
                U10, U4);
        g2.fill(body);
    ...
    /**
     * Checks if the mouse is located inside the body of the train engine
     *
     * @param mouseX x coordinate of mouse
     * @param mouseY y coordinate of mouse
     * @return if mouse point is inside the body
     */
    public boolean canBeClicked(int mouseX, int mouseY) {
        // If the body rectangle contains the mouse coordinates, it will return true
